...
top_parser.add_argument(
    "command", type=str, choices=["dataprep", "drc"], metavar="<command>"
)
...
def add_common_args(sub_parser):
    sub_parser.add_argument(
        "infile", type=argparse.FileType("rb"), help="the input gds file"
    )
    sub_parser.add_argument(
        "ymlspec",
        nargs="?",
...
dataprep_parser = argparse.ArgumentParser(
    prog="lymask dataprep", description="Command line mask dataprep"
)
...
def cm_dataprep(args):
    ...
    batch_main(
        dataprep_args.infile.name,
        ymlspec=dataprep_args.ymlspec,
        outfile=dataprep_args.outfile,
        technology=dataprep_args.technology,
    )


drc_parser = argparse.ArgumentParser(
    prog="lymask drc", description="Command line design rule check"
)
...
def cm_drc(args):
    ...
    batch_drc_main(
        drc_args.infile.name,
        ymlspec=drc_args.ymlspec,
        outfile=drc_args.outfile,
        technology=drc_args.technology,
    )
