...
from lymask.utilities import (
    ...
    gui_active_layout,
    gui_window,
    gui_active_technology,
    active_technology,
    set_active_technology,
...
def batch_main(infile, ymlspec=None, technology=None, outfile=None):
    ...
    layout.read(infile)
    lys.active_layout = layout
    ymlfile = resolve_ymlspec(
        ymlspec, technology, category="dataprep"
    )  # this also sets the technology
...
def batch_drc_main(infile, ymlspec=None, technology=None, outfile=None):
    ...
    lys.active_layout = layout
    ymlfile = resolve_ymlspec(
        ymlspec, technology, category="drc"
    )  # this also sets the technology
    tech_obj = active_technology()
    # Process it
    rdb = _drc_main(layout, ymlfile=ymlfile, tech_obj=tech_obj)
